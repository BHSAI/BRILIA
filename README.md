...
3. Download the BRILIA binary files for your OS. [Windows](https://github.com/BHSAI/BRILIA/releases/tag/v3.0.5win)  [Linux](https://github.com/BHSAI/BRILIA/releases/tag/v3.0.5linux)
