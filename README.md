...
## Installing BRILIA 
  ...
  4. Run BRILIA. If the OS asks for permission to modify files, "cancel" should work. See [here for more details](https://github.com/BHSAI/BRILIA/edit/master/GitDocs/FilePermission.md).
     ``` Windows> BRILIA.exe ```  
