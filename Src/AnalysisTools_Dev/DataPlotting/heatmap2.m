...
% HEATMAP2 displays a matrix as a heatmap image
%
% USAGE:
...
if nargin < 1, error('heatmap2 requires at least one input argument'); end
...
%Replace all NaN's into no text
displaytext(isnan(mat)) = {''};
